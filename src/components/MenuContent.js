      ...
      about: (
        <div className="textContain">
          <p id="menuP1" className="fadeIn">
            I’m a full stack nerd with an itch for dissecting confusing concepts
            and a knack for writing functional, organized, and DRY code. I
            currently work as a web and app devloper at Gramercy Tech, a digital
            consultancy.<br />
            <br />Outside of tech, I love spending time with my dog (Sasha),
            playing video games too much, and being outdoors.
          </p>
        </div>
      )
    })
